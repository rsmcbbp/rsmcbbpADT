...
% Last Modified by GUIDE v2.5 15-May-2018 16:56:49
...
function numm_Callback(hObject, eventdata, handles)
% hObject    handle to numm (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of numm as text
%        str2double(get(hObject,'String')) returns contents of numm as a double


% --- Executes during object creation, after setting all properties.
function numm_CreateFcn(hObject, eventdata, handles)
% hObject    handle to numm (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function nummm_Callback(hObject, eventdata, handles)
% hObject    handle to nummm (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of nummm as text
%        str2double(get(hObject,'String')) returns contents of nummm as a double


% --- Executes during object creation, after setting all properties.
function nummm_CreateFcn(hObject, eventdata, handles)
% hObject    handle to nummm (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
if index
    str=[pname fname];
    tyimage=imread(str);
    imshow(tyimage,'Parent',handles.axes1);
    axis off;
end
...
cBD=IRBD1(tyimage,Tyear);
imshow(cBD,'Parent',handles.axes2);
axis off;
...
Int=TYIntensity(fname,Tyear);
Int=round(Int*10)/10;
set(handles.num,'string',num2str(Int));
fname=[fname '.jpg'];
[ms ji]=kts2ms(Int);
set(handles.numm,'string',num2str(ms));
if ji<18
    set(handles.nummm,'string',num2str(ji));
else
    set(handles.nummm,'string','17+');
end
